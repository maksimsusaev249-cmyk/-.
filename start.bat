...
echo [4/4] Starting Game Engine and launching Desktop Window...
echo --------------------------------------------------------------------
echo Desktop Window client is starting!
echo Connecting to the central game server...
echo --------------------------------------------------------------------
echo.

:: Launch electron in a separate process and exit the terminal
start /b "" npx electron desktop-main.cjs
exit
